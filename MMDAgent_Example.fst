...
155  191  RECOG_EVENT_STOP|食堂               SYNTH_START|mei|mei_voice_normal|お昼には、学生、教授のみなさんがここで食事をしています。
191  192  <eps>                               MOTION_ADD|mei|action|Motion\mei_greeting\mei_greeting.vmd|PART|ONCE
192  193  SYNTH_EVENT_STOP|mei                SYNTH_START|mei|mei_voice_normal|分かりましたか？
...
155  201  RECOG_EVENT_STOP|小町               SYNTH_START|mei|mei_voice_normal|小町守准教授は、自然言語処理の分野で研究しています。
...
# 0211-0220 システムデザイン論（紹介）

155  211  RECOG_EVENT_STOP|システムデザイン論 SYNTH_START|mei|mei_voice_normal|木曜3限に行われている講義です。
211  212  <eps>                               MOTION_ADD|mei|action|Motion\mei_greeting\mei_greeting.vmd|PART|ONCE
212  213  SYNTH_EVENT_STOP|mei                SYNTH_START|mei|mei_voice_normal|分かりましたか？
...
155  221  RECOG_EVENT_STOP|13号館             SYNTH_START|mei|mei_voice_normal|ここでは主に、研究が行われています。
...
135  161  RECOG_EVENT_STOP|案内               SYNTH_START|mei|mei_voice_normal|かしこまりました。
...
175  271   RECOG_EVENT_STOP|二号館             MODEL_DELETE|menu
...
274  275   <eps>                               SYNTH_START|mei|mei_voice_normal|二号館は、正門から入り右側にある建物です。、
275  276   SYNTH_EVENT_STOP|mei                MOTION_ADD|mei|look|Motion\mei_look\mei_look_down.vmd|PART|ONCE
276  277   <eps>                               SYNTH_START|mei|mei_voice_normal|キャンパスマップでは、こちらになります。
...
279  280   <eps>                               SYNTH_START|mei|mei_voice_normal|お解りになりますか？
